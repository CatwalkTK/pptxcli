"""Playwright test: screenshot review page and examine generated CLI code outputs for iteration 2."""
import json
from pathlib import Path
from playwright.sync_api import sync_playwright

WORKSPACE = Path(r"C:\ai\pptx\.claude\skills\cli-builder-workspace\iteration-2")
